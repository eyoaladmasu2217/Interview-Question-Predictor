...
st.markdown("""
    ...
    .main-header h1 { color: white !important; font-weight: 700; margin: 0; font-size: 2.5rem; text-shadow: 1px 1px 2px rgba(0,0,0,0.1); }
    ...
    .badge-hard       { background-color: #fecaca; color: #991b1b; }
        ...
        if len(question) > 5000:
            ...
            if not predictor.cat_model:
                ...
                with col_results:
                    ...
                    count_cols[1].metric("Char Count", len(question))
